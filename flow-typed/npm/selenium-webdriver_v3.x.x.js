// flow-typed signature: ac8e3296d53470dff7365767bcb30310
// flow-typed version: 437da298c7/selenium-webdriver_v3.x.x/flow_>=v0.28.x
...
declare class webdriver$Entry {
  constructor(
    level: { value: number, name: string } | string,
    message: string,
